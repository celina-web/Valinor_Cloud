...
aplicando reglas de negocio (sin turnos superpuestos, estados de turno, etc.).
...
│   ├── data/
│   │   └── db.js                # Helper de lectura/escritura de los JSON
...
│   ├── middlewares/             # logger, validaciones, manejo de errores
...
- **Middleware**: `logger` (registro de peticiones), validaciones de datos, manejo de
  errores y 404, y `express.static` para servir archivos.
